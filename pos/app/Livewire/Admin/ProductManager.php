...
// Inside the Livewire component class (ProductManager.php)
    public $createMode = false;

// Method to toggle the create product form
    ...
    public function render()
    {
        ...
        $sauces = Sauce::all();
        return view('livewire.admin.product-manager',compact('categories', 'sauces'));
